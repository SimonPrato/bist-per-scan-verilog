...
module lfsr16 (
    ...
    input  wire        enable,    // shift when 1   (this will be controlled by bists output "running")
    ...
    // taps: 15, 14, 12, 3 (bit 15 is MSB)
    assign feedback = state[15] ^ state[13] ^ state[12] ^ state[3];
