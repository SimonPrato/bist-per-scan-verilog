...
# Read the circuit
read_hdl circuito08.v

# Elaboration (pre-synthesis)
elaborate circuito08
...
# Generate reports
report qor
write_hdl -mapped > sources/circuito08_scan_syn.v 
write_sdc >  reports/circuito08_scan.sdc
write_scandef >  reports/circuito08_scan_chain.txt
write_atpg -stil >  reports/circuito08_scan.stil
report gates >  reports/circuito08_scan_gates.txt
report timing >  reports/circuito08_scan_timing.txt
report power >  reports/circuito08_power.txt
